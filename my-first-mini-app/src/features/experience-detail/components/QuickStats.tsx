  ...
  return (
    <div className="flex flex-wrap gap-6 items-center bg-surface-container-lowest p-5 rounded-2xl shadow-sm border border-outline-variant/10">
      ...
      <div className="flex items-center gap-2 border-r border-outline-variant/30 pr-6">
        ...
        <div>
          <span className="font-h3 text-on-surface">{rating.toFixed(1)}</span>
          <span className="font-body-sm text-secondary ml-1">({ratingCount} reviews)</span>
        </div>
      </div>
      ...
      <div className="flex items-center gap-2 border-r border-outline-variant/30 pr-6">
        ...
        <span className="font-body-md text-on-surface">3 Hours</span>
      </div>

      {/* Group size */}
      <div className="flex items-center gap-2">
        <Users size={20} strokeWidth={2} className="text-secondary" />
        <span className="font-body-md text-on-surface">Max 10</span>
      </div>
    </div>
  );
}

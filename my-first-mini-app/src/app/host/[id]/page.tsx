...
function ExpImagePlaceholder() {
  return (
    <div className="absolute inset-0 flex items-center justify-center bg-[#f4dddb]">
      <svg width="40" height="40" fill="none" stroke="#8b716e" strokeWidth="1.5"
    ...
    <div className="min-h-screen bg-[#fff8f7]">
      ...
      <header className="sticky top-0 z-40 flex justify-between items-center w-full px-5 h-16 bg-[#fff8f7] shadow-sm">
        <button
          ...
          aria-label="Go back"
        >
          <svg width="22" height="22" fill="none" stroke="#a7322f" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
        ...
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none">
            <circle cx="12" cy="5" r="1.5" fill="#251918" />
            <circle cx="12" cy="12" r="1.5" fill="#251918" />
            <circle cx="12" cy="19" r="1.5" fill="#251918" />
          </svg>
        </button>
      </header>
            ...
            {stats.map((stat, i) => (
              <div key={i} className="flex-1 px-2">
                <div className="flex items-center justify-center gap-1 font-quicksand-bold text-2xl text-[#251918] mb-1">
                  {stat.value}
                  {stat.star && (
                    <svg width="18" height="18" viewBox="0 0 24 24" fill="#d3a500" stroke="#d3a500" strokeWidth="1">
                      <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
                    </svg>
                  )}
                </div>

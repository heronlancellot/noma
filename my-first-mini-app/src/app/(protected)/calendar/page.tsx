  ...
  return (
    <div style={{ backgroundColor: '#fff8f7', minHeight: '100vh' }}>
      ...
      >
        ...
        >
          <svg width="18" height="18" fill="none" stroke="#a7322f" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
                      ...
                      >
                        ...
                        {exp.location && (
                          <div className="flex items-center gap-1.5">
                            <svg width="13" height="13" fill="none" stroke="#58413f" strokeWidth="2" viewBox="0 0 24 24">
                ...
                return (
                  ...
                  >
                    ...
                    <div
                      ...
                      style={{ backgroundColor: '#f4dddb' }}
                    >
                      <svg width="14" height="14" fill="none" stroke="#a7322f" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24">
